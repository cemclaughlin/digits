    ...
    return (
        ...
        <Grid container centered stackable columns={3}>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as = 'h3' inverted>This address book enables user to register and save their business contacts. YOu can only see the contacts you have created.</Header>
          </Grid.Column>
          ...
          <Grid.Column textAlign='center'>
            <Icon name = 'checked calendar' size = 'huge' inverted/>
